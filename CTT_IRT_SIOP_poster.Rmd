...
```{r example, include=TRUE, fig.cap="Item characteristic curves primarily reflecting differences in discrimination.", echo=FALSE, warning=FALSE, message=FALSE, out.width = "100%"}
...
pseudob3<-abs(qnorm(.02))
pseudoa3<-ahat(0.7)
p3 <- function(x){c + ((1-c)*(1/(1+2.71828^(-1.7*(pseudoa3*(x-pseudob3))))))}
pseudob4<-abs(qnorm(.001))
pseudoa4<-ahat(0.2)
p4<- function(x){c + ((1-c)*(1/(1+2.71828^(-1.7*(pseudoa4*(x-pseudob4))))))}

colors<-c("High Discrimination & Low Difficulty"="cyan", "Low Discrimination & Low Difficulty"="cyan3", "Low Discrimination & High Difficulty"="brown1", "High Discrimination & High Difficulty"="brown3")
library(ggplot2)
library(scales)
base <-
  ggplot()
...
base+
  xlim(-3,3)+
  geom_function(fun=p, size=3, linetype="dashed", aes(color="High Discrimination & Low Difficulty"))+
  geom_function(fun=p2, size=3, aes(color="Low Discrimination & Low Difficulty"))+
  geom_function(fun=p3, size=3, aes(color="Low Discrimination & High Difficulty"))+
  geom_function(fun=p4, size=3, linetype="dashed", aes(color="High Discrimination & High Difficulty"))+
  labs(x="Thetas",
       y="p(x)",
       color="Legend")+
...
```{r img-with-knitr, echo=FALSE, fig.align='right', out.width='100%'}
